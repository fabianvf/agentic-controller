...
- The platform is insensitive to whether a given cluster applies `noexec` to
  ...
  matrix.
- `make dev-probe` re-answers the question on any cluster. It should be re-run
...
- `hack/dev/pr53-test.sh` — the real-agent experiment behind §3
- `docs/local-development.md` — how to run it
